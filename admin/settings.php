...
function iwp_get_shop_states( $country = null ) {
	...
	switch( $country ) :
		...
		case 'US' :
			$states = iwp_get_states_list();
			break;
		case 'CA' :
			$states = iwp_get_provinces_list();
			break;
		case 'AU' :
			$states = iwp_get_australian_states_list();
			break;
		case 'BD' :
			$states = iwp_get_bangladeshi_states_list();
			break;
		case 'BG' :
			$states = iwp_get_bulgarian_states_list();
			break;
		case 'BR' :
			$states = iwp_get_brazil_states_list();
			break;
		case 'CN' :
			$states = iwp_get_chinese_states_list();
			break;
		case 'HK' :
			$states = iwp_get_hong_kong_states_list();
			break;
		case 'HU' :
			$states = iwp_get_hungary_states_list();
			break;
		case 'ID' :
			$states = iwp_get_indonesian_states_list();
			break;
		case 'IN' :
			$states = iwp_get_indian_states_list();
			break;
		case 'IR' :
			$states = iwp_get_iranian_states_list();
			break;
		case 'IT' :
			$states = iwp_get_italian_states_list();
			break;
		case 'JP' :
			$states = iwp_get_japanese_states_list();
			break;
		case 'MX' :
			$states = iwp_get_mexican_states_list();
			break;
		case 'MY' :
			$states = iwp_get_malaysian_states_list();
			break;
		case 'NP' :
			$states = iwp_get_nepalese_states_list();
			break;
		case 'NZ' :
			$states = iwp_get_new_zealand_states_list();
			break;
		case 'PE' :
			$states = iwp_get_peruvian_states_list();
			break;
		case 'TH' :
			$states = iwp_get_thailand_states_list();
			break;
		case 'TR' :
			$states = iwp_get_turkey_states_list();
			break;
		case 'ZA' :
			$states = iwp_get_south_african_states_list();
			break;
		case 'ES' :
			$states = iwp_get_spain_states_list();
			break;
		default :
			$states = array();
			break;
	...
	return apply_filters( 'iwp_shop_states', $states );
}
...
function iwp_get_country_list() {
	...
	return apply_filters( 'iwp_countries', $countries );
}
...
function iwp_get_states_list() {
	...
	return apply_filters( 'iwp_us_states', $states );
}
 ...
 * @return      array
 */
function iwp_get_provinces_list() {
	$provinces = array(
		''   => '',
		'AB' => 'Alberta',
		'BC' => 'British Columbia',
	...
	return apply_filters( 'iwp_canada_provinces', $provinces );
}
 ...
 */
function iwp_get_australian_states_list() {
	$states = array(
		''    => '',
	...
	return apply_filters( 'iwp_australian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_bangladeshi_states_list() {
	$states = array(
		''    => '',
		'BAG' => 'Bagerhat',
		'BAN' => 'Bandarban',
	...
	return apply_filters( 'iwp_bangladeshi_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_brazil_states_list() {
	$states = array(
		''   => '',
		'AC' => 'Acre',
		'AL' => 'Alagoas',
	...
	return apply_filters( 'iwp_brazil_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_bulgarian_states_list() {
	$states = array(
		''      => '',
		'BG-01' => 'Blagoevgrad',
		'BG-02' => 'Burgas',
	...
	return apply_filters( 'iwp_bulgarian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_hong_kong_states_list() {
	$states = array(
		''                => '',
	...
	return apply_filters( 'iwp_hong_kong_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_hungary_states_list() {
	$states = array(
		''   => '',
		'BK' => 'Bács-Kiskun',
		'BE' => 'Békés',
	...
	return apply_filters( 'iwp_hungary_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_japanese_states_list() {
	$states = array(
		''     => '',
		'JP01' => 'Hokkaido',
		'JP02' => 'Aomori',
	...
	return apply_filters( 'iwp_japanese_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_chinese_states_list() {
	$states = array(
		''     => '',
	    'CN1'  => 'Yunnan / &#20113;&#21335;',
	    'CN2'  => 'Beijing / &#21271;&#20140;',
	...
	return apply_filters( 'iwp_chinese_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_new_zealand_states_list() {
	$states = array(
		''   => '',
		'AK' => 'Auckland',
		'BP' => 'Bay of Plenty',
	...
	return apply_filters( 'iwp_new_zealand_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_peruvian_states_list() {
	$states = array(
		''    => '',
		'CAL' => 'El Callao',
	...
	return apply_filters( 'iwp_peruvian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_indonesian_states_list() {
	$states  = array(
		''   => '',
	...
	return apply_filters( 'iwp_indonesia_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_indian_states_list() {
	$states = array(
		''   => '',
		'AP' => 'Andhra Pradesh',
	...
	return apply_filters( 'iwp_indian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_iranian_states_list() {
	$states = array(
		''    => '',
		'KHZ' => 'Khuzestan',
		'THR' => 'Tehran',
	...
	return apply_filters( 'iwp_iranian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_italian_states_list() {
	$states = array(
		''   => '',
		'AG' => 'Agrigento',
		'AL' => 'Alessandria',
	...
	return apply_filters( 'iwp_italian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_malaysian_states_list() {
	$states = array(
		''    => '',
		'JHR' => 'Johor',
		'KDH' => 'Kedah',
	...
	return apply_filters( 'iwp_malaysian_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_mexican_states_list() {
	$states = array(
		''    => '',
	...
	return apply_filters( 'iwp_mexican_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_nepalese_states_list() {
	$states = array(
		''    => '',
		'ILL' => 'Illam',
		'JHA' => 'Jhapa',
	...
	return apply_filters( 'iwp_nepalese_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_south_african_states_list() {
	$states = array(
		''    => '',
		'EC'  => 'Eastern Cape',
		'FS'  => 'Free State',
	...
	return apply_filters( 'iwp_south_african_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_thailand_states_list() {
	$states = array(
		''      => '',
	...
	return apply_filters( 'iwp_thailand_states', $states );
}
 ...
 * @return array $states A list of states
 */
function iwp_get_turkey_states_list() {
	$states = array(
		''     => '',
		'TR01' => 'Adana',
		'TR02' => 'Ad&#305;yaman',
	...
	return apply_filters( 'iwp_turkey_states', $states );
}
